...
$( function() {
			...
			var chatbot = {
					//#### PROPERTIES ####
					greeting: "Hi there! Im Susan, Hope you are having a great day!",
					questions: {
        ...
        ask: function(message) {
            $('#conversation').append('<li class="list-group-item text-left"><i id="susan" class="fas fa-chalkboard-teacher"></i>  ' + message + '</li>');
        },
        answer: function() {
            var answer = $('#message').val() + "  <i id='me' class='fas fa-user'></i>";
            if(answer)
            {
